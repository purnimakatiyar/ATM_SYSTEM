...
class Admin(Customer):
    ...
    def add_customer(self):
        ...
        if count > 0:
            ...
            Database.get_item(queries.INSERT_INTO_AUTH_TABLE, self.unique_id, self.security_code, config.ROLE)
    ...
    def remove_customer(self, unique_id):
        while True:
            count = Database.get_item(queries.SEARCH_EXISTING_USER_IN_ACCOUNT, unique_id)[0]
            if count > 0:
                Database.update_item(queries.DELETE_FROM_ACCOUNT_TABLE, unique_id)
